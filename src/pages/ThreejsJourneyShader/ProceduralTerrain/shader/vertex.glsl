...
float getElevation(vec2 position)
{
    ...
    elevation += simplexNoise2d(warpPosition * uPositionFrequency) / 2.0;
    elevation += simplexNoise2d(warpPosition * uPositionFrequency * 2.0) / 4.0;
    elevation += simplexNoise2d(warpPosition * uPositionFrequency * 4.0) / 8.0;
